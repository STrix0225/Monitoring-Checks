...
class _DashboardNgPageState extends State<DashboardNgPage> with SingleTickerProviderStateMixin {
  ...
  void _handleTabChange() {
    // Paksa rebuild ketika tab berubah agar FAB berubah
    if (mounted) {
      setState(() {});
    }
  }
